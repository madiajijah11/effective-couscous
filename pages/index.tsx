			...
			<div className="flex justify-center">
				<div className="prose">
					...
					<p>
						...
						necessitatibus earum! Ad, consequatur? Fugiat natus consectetur animi
						tenetur deleniti!
					</p>
					<p>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat repellendus
						quibusdam vitae ducimus neque, illo recusandae voluptates sint debitis,
						aperiam maxime corporis incidunt quas, cupiditate ipsum enim voluptatem
						dignissimos sed.
					</p>
					<p>
						...
						officia itaque perspiciatis tempore perferendis vero, sint illo quidem
						cumque.
					</p>
				</div>
			</div>
